...
const SKS_FAUCET_ID = "0x7e1d75334832f85106a9cd4757abb0";
...
export function PredictionPanel() {
  ...
  const submitPrediction = async () => {
    ...
    try {
      ...
      setStatus(`✅ On-Chain Tranzaksiya Uğurla İcra Olundu! (${choice}: ${sendUnits} SKS)`);
      ...
      if (msg.includes("Intercom") || msg.includes("Not Found")) {
        setStatus("⚠️ Bread Wallet extension əlaqəsi kəsildi. Zəhmət olmasa chrome://extensions səhifəsindən Bread Wallet-i Reload (🔄) edin və səhifəni yeniləyin.");
      } else if (msg.includes("User rejected") || msg.includes("Cancel") || err?.code === 4001) {
